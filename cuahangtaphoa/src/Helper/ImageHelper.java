...
public class ImageHelper {
	...
	public static byte[] toByteArray(Image img,String type) throws IOException {
		BufferedImage bitmap = new BufferedImage(img.getWidth(null), img.getHeight(null),BufferedImage.TYPE_INT_RGB);
		Graphics2D grap = bitmap.createGraphics();
		grap.drawImage(img, 0, 0, null);
		grap.dispose();
		
		ByteArrayOutputStream baos = new ByteArrayOutputStream(); 
		ImageIO.write(	bitmap, type, baos);
